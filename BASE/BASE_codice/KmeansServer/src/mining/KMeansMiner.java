...
public class KMeansMiner {
    ...
    /**
     * Restituisce l'insieme dei cluster C
     *
     ...
     * @return numero d'iterazioni eseguite
     * @throws OutOfRangeSampleSize il numero k di cluster inserito dall'utente è maggiore
