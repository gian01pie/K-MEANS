...
public class DbAccess {
    ...
    public void initConnection() throws DatabaseConnectionException {
        ...
        // quindi gestisco l'eccezione esternamente
            ...
            System.out.println("[!] Driver non trovato: " + err.getMessage());
            throw new DatabaseConnectionException();
        } catch (InstantiationException err){
            System.out.println("[!] Errore durante l'istanziazione: " + err.getMessage());
            throw new DatabaseConnectionException();
        } catch (IllegalAccessException err){
            System.out.println("[!] Impossibile accedere al Driver: " + err.getMessage());
            throw new DatabaseConnectionException();
        }
